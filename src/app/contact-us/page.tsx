    ...
    <>
      <Content>
        ...
        <Text as="p">
          ...
          {". "}
          Feel free to report bugs, request features, or contribute to the
          project.
        </Text>
        ...
        <Text as="p">
          We welcome feature requests! Please open an issue on our GitHub
          repository with the &quot;enhancement&quot; label. Describe the
          feature you&apos;d like to see and explain how it would benefit users.
        </Text>
      </Content>
      <Sidebar>
        <RepoSidebar />
