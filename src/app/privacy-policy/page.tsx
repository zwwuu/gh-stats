  ...
  return (
    <>
      <Content>
        ...
        <Text as="p">
          At {siteName}, accessible from {siteUrl}, one of our main priorities
          is the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by {siteName} and
          how we use it.
        </Text>
        ...
        <ul>
          <li>
            ...
            type, browser version, the pages you visit, the time and date of
            your visit, and other diagnostic data.
          </li>
          <li>
            <strong>GitHub Data:</strong> We fetch publicly available repository
            information from the GitHub API. This data is not stored permanently
            and is used only to display statistics.
          </li>
          <li>
            <strong>Local Storage:</strong> We use browser local storage to save
            your preferences, bookmarks, and theme settings. This data remains
        ...
        <Text as="p">
          Like any other website, {siteName} uses &lsquo;cookies&rsquo;. These
        ...
        <Text as="p">
          ...
          are not owned or controlled by {siteName}. We have no control over,
          and assume no responsibility for, the content, privacy policies, or
          practices of any third-party websites or services. We strongly advise
        ...
        <Text as="p">
          We do not store personal data on our servers. All user preferences and
          bookmarks are stored locally in your browser&apos;s local storage.
          GitHub repository data is fetched in real-time from the GitHub API and
          may be cached temporarily for performance purposes.
        </Text>
        ...
        <Text as="p">
          ...
          through our <Anchor href="/contact-us">Contact page</Anchor> or via
          our{" "}
