  ...
  return (
    <>
      <Content>
        ...
        <Text as="p">
          By accessing the website at {siteUrl}, you are agreeing to be bound by
        ...
        <Text as="p">
          Permission is granted to temporarily access and use {siteName} for
        ...
        <Text as="p">
          ...
          owned by {siteName} and are protected by international copyright,
          trademark, patent, trade secret, and other intellectual property laws.
        </Text>
        <Text as="p">
          All GitHub data displayed on this site is sourced from the GitHub API
          and remains the property of GitHub, Inc. and the respective repository
          owners.
        </Text>

        <Heading as="h2">5. Disclaimer</Heading>
        <Text as="p">
          The materials on {siteName}&apos;s website are provided on an &apos;as
          is&apos; basis. {siteName} makes no warranties, expressed or implied,
        ...
        <Text as="p">
          {siteName} does not warrant or make any representations concerning the
        ...
        <Text as="p">
          In no event shall {siteName} or its suppliers be liable for any
          damages (including, without limitation, damages for loss of data or
          profit, or due to business interruption) arising out of the use or
          inability to use the materials on {siteName}&apos;s website, even if{" "}
          {siteName} or an authorized representative has been notified orally or
          in writing of the possibility of such damage.
        </Text>

        <Heading as="h2">7. Service Availability</Heading>
        <Text as="p">
          We strive to provide uninterrupted access to our service, but we do
        ...
        <Text as="p">
          ...
          {siteName}. We have no control over, and assume no responsibility for,
        ...
        <Text as="p">
          {siteName} may revise these terms of service at any time without
        ...
        <Text as="p">
          ...
          with the laws of the jurisdiction in which {siteName} operates, and
