        ...
        >
          <Stack>
            <Text as="p" className={styles.body}>
              GitHub limits unauthenticated API calls to 60 requests per hour
              per IP address. Enter a GitHub Fine-Grained or Personal Access
              Token (PAT) to increase your limit to 5,000 requests per hour.
            </Text>

            <div>
              <Text as="h3" className={styles.body} weight="semibold">
                Current Status
              </Text>
              <Text as="p" className={styles.body}>
                Limit:{" "}
